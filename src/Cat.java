...
// let's create a folder for this file
    ...
    public static void catCreateFile () throws IOException {
        ...
        Path catFile = Files.createFile (Paths.get ("C:\\CatTask\\testCatFile.txt"));
    }

    public static void catSerializable () throws IOException {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\CatTask\\testCatFile.txt")))
        {
            Cat ca = null;
            ca = new Cat ();
            oos.writeObject(ca);
